...
<div class="wrapper wrapper-content">
    <div class="row animated fadeInRight">
            ...
            <div class="ibox float-e-margins">
                ...
                <div>
                    <div class="ibox-content no-padding border-left-right">
                        <img alt="image" class="img-responsive" src="<%=basePath%>resources/img/profile_big.jpg">
                    </div>
        ...
        <div class="col-sm-8">
                        ...
                        <div class="feed-activity-list">
                            ...
                            <div class="feed-element">
                                <a href="profile.html#" class="pull-left">
                                    <img alt="image" class="img-circle" src="<%=basePath%>resources/img/a1.jpg">
                                </a>
                            ...
                            <div class="feed-element">
                                <a href="profile.html#" class="pull-left">
                                    <img alt="image" class="img-circle" src="<%=basePath%>/resources/img/profile.jpg">
                                </a>
                                <div class="media-body ">
                            ...
                            <div class="feed-element">
                                <a href="profile.html#" class="pull-left">
                                    <img alt="image" class="img-circle" src="<%=basePath%>resources/img/a2.jpg">
                                </a>
                                <div class="media-body ">
                            ...
                            <div class="feed-element">
                                <a href="profile.html#" class="pull-left">
                                    <img alt="image" class="img-circle" src="<%=basePath%>resources/img/a3.jpg">
                                </a>
                                <div class="media-body ">
                                    ...
                                    <div class="photos">
                                        <a target="_blank" href="http://24.media.tumblr.com/20a9c501846f50c1271210639987000f/tumblr_n4vje69pJm1st5lhmo1_1280.jpg">
                                            <img alt="image" class="feed-photo" src="<%=basePath%>resources/img/p1.jpg">
                                        </a>
                                        <a target="_blank" href="http://37.media.tumblr.com/9afe602b3e624aff6681b0b51f5a062b/tumblr_n4ef69szs71st5lhmo1_1280.jpg">
                                            <img alt="image" class="feed-photo" src="<%=basePath%>resources/img/p3.jpg">
                                        </a>
                                    </div>
                                </div>
                            </div>
            ...
            <div class = "row">
            <div class="col-sm-12">
                <EMBED src="<%=basePath%>/resources/music/shaonianjinshi.mp3" width=300 height=45 type=audio/mpeg loop="-1" autostart="false" volume="0"></EMBED>
            </div>
        </div>
        </div>
    </div>
...
<script src="<%=basePath%>resources/script/index.js"></script>
</body>
